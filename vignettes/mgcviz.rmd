...
2. model checks: interactive QQ-plots and layered residuals checks along one or two covariates;

3. special plots: differences-between-smooths plots in 1 or 2D.


## 1 Layered smooth effect plots

Here we start by describing effect-specific plotting methods and then we move to the new `plot.gam` function, which wraps several plots together.
...
# Commented out to avoid error when building the vignette
# library(plotly)
...
```{r 21}
qq(lr.fit, rep = 20, show.reps = T, CI = "none",
