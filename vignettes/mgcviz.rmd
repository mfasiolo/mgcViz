---
title: "mgcViz: visual tools for GAMs"
...
This produces two view along $x$ and $z$, but as you can see the plots are initially empty. We might
...
#### 3.1 Differences-between-smooths plots
...
#### 3.2 Plotting multiple slices of multi-dimensional smooth effects
